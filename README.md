...
**61 tools** across all 26 protocol modules. Works with any MCP client: Claude Desktop, Cursor, Windsurf, and more.
...
- npm SDK: [agent-passport-system](https://www.npmjs.com/package/agent-passport-system) (v1.14.11, 771 tests)
