...
**106 tools** across 42 core modules + 32 v2 constitutional governance modules (separation of powers, circuit breakers, approval fatigue detection, and more). Works with any MCP client: Claude Desktop, Cursor, Windsurf, and more.
...
Auto-configures Claude Desktop and Cursor. Restart your AI client. 106 tools ready.
...
- npm SDK: [agent-passport-system](https://www.npmjs.com/package/agent-passport-system) (v1.23.0, 1436 tests)
